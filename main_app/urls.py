...
urlpatterns = [
    ...
    path('campaign/<int:pk>/location/', views.Location_List.as_view(), name="Location_List"),
    path('campaign/<int:pk>/location/create/', views.Location_Create.as_view(), name="Location_Create"),
